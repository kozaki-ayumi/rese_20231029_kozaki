        ...
        <div class="reservation__position">
            ...
            <div class="reservation__confirm">
                <div class="reservation__title">
                    <div class="reservation__title-name">予約{{$key+1}}</div>
                ...
                <table class="table">
                <form action = "/reservation/change" method="post">
                    @method('PATCH')
                    @csrf
                <input type="hidden" name="reservation_id" value="{{$reservation['id']}}" >
                    <tr> 
                ...
                <div class="change__btn">
                    <button class="change__btn-content">予約変更</button>
                </div>
                </form>
            </div>
            @endforeach
        </div>
        <div class="past__reservation">
            <h2 class="reservation__position-title">過去3ヶ月の予約</h2>
            @foreach($reservationPasts as $key=>$reservationPast)
            <div class="reservation__confirm-past">
                <div class="reservation__title">
                    <div class="reservation__title-name">予約{{$key+1}}</div>
                </div>
                <table class="table">
                  ...
                  <tr>
                    <th align="left" width="80" height="30">Date</th>
                    <td align="left" width="80" height="30">{{$reservationPast['date']}}</td>
                  <tr>
                    <th align="left" width="80" height="30">Time</th>
                ...
                <div class="review">
                    ...
                    <div class="comment__title">コメント</div>
